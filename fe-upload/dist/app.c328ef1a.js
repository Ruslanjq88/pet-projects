...
var firebaseConfig = {
  apiKey: "AIzaSyBWNtum-bpk-E_r25DYi0R6yG6sjAZH1ck",
  authDomain: "fe-upload-88.firebaseapp.com",
  projectId: "fe-upload-88",
  storageBucket: "fe-upload-88.appspot.com",
  messagingSenderId: "562210686997",
  appId: "1:562210686997:web:2def3179a745a95a26a61c"
};
  ...
  onUpload: function onUpload(files, blocks) {
    files.forEach(function (file, index) {
      ...
      task.on('state_changed', function (snapshot) {
        ...
        (0, _storage.getDownloadURL)(task.snapshot.ref).then(function (url) {
